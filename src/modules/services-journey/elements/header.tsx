...
import HeaderImage from '@public/podroz.jpg'
...
const ServicesForgivenessPageHeader: React.FC = () => {
  ...
  return (
    <header className="relative pt-6 space-y-5 flex justify-center items-center lg:py-12 lg:mt-12  bg-primary mb-12">
        ...
        <div className="flex flex-col p-5 gap-10 mx-auto w-full lg:p-0 lg:gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="space-y-2 lg:w-[400px] xl:w-[500px] 2xl:w-[550px]">
            <Image
              src={HeaderImage.src}
              alt="Ecommerce"
              className="rounded-xl lg:w-[400px] xl:w-[500px] 2xl:w-[550px] lg:h-[200px] xl:h-[300px] 2xl:h-[330px]"
              placeholder="blur"
