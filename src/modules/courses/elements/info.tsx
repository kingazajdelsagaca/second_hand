...
const CoursesPageInfo = (props: props) => {
  const { title, content, path } = props;
  const translation = useTranslations("Courses.Content");
  return (
    <>
      {title ? (
        <div className="relative  pt-6 pb-6 space-y-5 flex justify-center flex-column items-center lg:pt-3">
...
export default CoursesPageInfo;
